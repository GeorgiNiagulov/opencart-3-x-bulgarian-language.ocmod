...
$_['entry_image_thumb']                = 'Размери на изображение за продукт (Ш x В)';
$_['entry_image_popup']                = 'Размери на изображение за продукт (попъп) (Ш x В)';
...
$_['entry_image_location']             = 'Размери на изображение за лого на сайта (Ш x В)';
